...
class TestRegEx(unittest.TestCase):
    ...
    def test_1(self):
        ...
        res2 = 'NL-AsdNIOD_400_01868/preservation/NL-AsdNIOD_400_01868_00001.jpg'
        self.assertEqual(res2,make_target(res),'test1b failed')
    ...
    def test_2(self):
        ...
        res2 = 'NL-AsdNIOD_181c_00036/transcription/NL-AsdNIOD_181c_00036_00003.xml'
        self.assertEqual(res2,make_target(res),'test2b failed')
    ...
    def test_3(self):
        ...
        res2 = 'NL-AsdNIOD_293_398/preservation/NL-AsdNIOD_293_398_093.jpg'
        self.assertEqual(res2,make_target(res),'test3b failed')

    def test_4(self):
        res = do_search('NL-AsdNIOD_250g_0456-73.pdf')
        exp = ['a','250g','0456','73','pdf']
        self.assertEqual(res,exp,'test4a failed')
        res2 = 'NL-AsdNIOD_250g_0456/transcription/NL-AsdNIOD_250g_0456_73.pdf'
        self.assertEqual(res2,make_target(res),'test4b failed')
    ...
    def test_5(self):
        ...
        res2 = 'NL-AsdNIOD_249_0215C/transcription/NL-AsdNIOD_249_0215C_01.pdf'
        self.assertEqual(res2,make_target(res),'test5b failed')
    ...
    def test_6(self):
        ...
        res2 = 'NL-AsdNIOD_400_01868/preservation/NL-AsdNIOD_400_01868_00001.jpg'
        self.assertEqual(res2,make_target(res),'test6b failed')
    ...
    def test_7(self):
        ...
        res2 = 'NL-AsdNIOD_250d_0053/preservation/NL-AsdNIOD_250d_0053_01.jpg'
        self.assertEqual(res2,make_target(res),'test7b failed')
    ...
    def test_8(self):
        ...
        res2 = 'NL-AsdNIOD_400_3991/bladzij 51.jpg'
        self.assertEqual(res2,make_target(res),'test8b failed')

    def test_9(self):
        res = do_search('/data/m/Doc II/249-A1180/249-A1180_16.jpg')
        exp = ['a','249','A1180','16','jpg']
        self.assertEqual(res,exp,'test9a failed')
        res2 = 'NL-AsdNIOD_249_A1180/preservation/NL-AsdNIOD_249_A1180_16.jpg'
        self.assertEqual(res2,make_target(res),'test9b failed')
    ...
    def test_10(self):
        ...
        res2 = 'NL-AsdNIOD_249_A1084/preservation/NL-AsdNIOD_249_A1084_307.JPG'
        self.assertEqual(res2,make_target(res),'test10b failed')
    ...
    def test_11(self):
        ...
        res2 = 'NL-AsdNIOD_247_1601/247_16010_herdenkingstekst.docx'
        self.assertEqual(res2,make_target(res),'test11b failed')
